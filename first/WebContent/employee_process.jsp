...
int i=st.executeUpdate("insert into schedule (drawbreak1,drawbreak2,drawbreak3,drawbreak4,drawbreak5,drawbreak6,drawbreak7,drawbreak8,drawbreak9,drawbreak10,drawbreak11,drawbreak12,drawbreak13,drawbreak14,drawbreak15) values('"+drawbreak1+"','"+drawbreak2+"','"+drawbreak3+"','"+drawbreak4+"','"+drawbreak5+"','"+drawbreak6+"','"+drawbreak7+"','"+drawbreak8+"','"+drawbreak9+"','"+drawbreak10+"','"+drawbreak11+"','"+drawbreak12+"','"+drawbreak13+"','"+drawbreak14+"','"+drawbreak15+"')");
