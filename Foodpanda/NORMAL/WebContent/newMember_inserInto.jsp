...
int i=st.executeUpdate("insert into staff (memberID,jobtitle,shift,name,gender,birthday,identitycard,phonenumber,email,lineID,address,ec,ecphonenumber,ecrelationships,arrivalday,turnoverdate,remark)values('"+memberID+"','"+jobtitle+"','"+shift+"','"+name+"','"+gender+"','"+birthday+"','"+identitycard+"','"+phonenumber+"','"+email+"','"+lineID+"','"+address+"','"+ec+"','"+ecphonenumber+"','"+ecrelationships+"','"+arrivalday+"','"+turnoverdate+"','"+remark+"')");
