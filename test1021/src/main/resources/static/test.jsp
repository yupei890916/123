...
<%
	Statement stmt = null;  
	ResultSet rs = null;  
	String sql = "SELECT schedule.resource.name,schedule.event.end,schedule.event.text
FROM schedule.event,schedule.resource
where schedule.event.resource_id = schedule.resource.id and schedule.event.status = "1";";  
